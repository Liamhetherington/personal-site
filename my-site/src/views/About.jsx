      ...
      <div className="about-body">
        <div className="about-banner">
          <div className="about-banner-text">
            ...
            <p>We are a results driven technical solutioning firm that will help your brand build it's online presence. Our mission is to provide clean and concise code driving higher conversion and lead rates. In order to achieve these results we use a wide skillset of SEO, responsive design, React app development, and Wordpress/Drupal Content Management Systems.</p>
          </div>
        </div>
